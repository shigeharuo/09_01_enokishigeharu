    ...
    <form method="post" action="update.php">
        ...
        <div class="form-group">
            <div class="form-MP">
                ...
                <label for="product" class="MG0">商品</label>
                <input type="text" class="form-control" id="product" name="product" value="<?= $rs['product'] ?>" disabled="disabled">

            </div>
            <div class="form-MP">
                <label for="category" class="MG0">カテゴリー</label>
                <select type="example" class="form-control" id="category" name="category" disabled="disabled">
            ...
            <div class="form-MP">
                ...
                <input type="number" class="form-control" id="kane_price" name="kane_price" min="0" max="10000" value="<?= $rs['kane_price'] ?>" disabled="disabled" step="0">
            </div>
            <div class="form-MP">
                <label for="basyo_place" class="MG0">いつも買う場所</label>
                <input type="text" class="form-control" id="basyo_place" name="basyo_place" value="<?= $rs['basyo_place'] ?>" disabled="disabled">
            </div>
            ...
            <div class="form-MP">
                ...
                <select type="example" class="form-control" id="enough" name="enough" disabled="disabled">
            ...
            <div class="form-MP">
                ...
                <select type="" class="form-control" id="ONOFF" name="ONOFF" disabled="disabled">
            ...
            <div class="form-group">
                <a href="select_nologin.php?" class=" btn btn-primary">戻 る</a> 変更が必要な場合は <a href="login.php">ログイン</a> おねがしいます。
            </div>
